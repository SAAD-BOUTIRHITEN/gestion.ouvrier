...
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 style="color: red" class="mb-0">Les farines et Semoules</h4>
        </div>
        <div class="col-sm-6">
                            ...
                            <tr>
                                ...
                                <td> <a class="modal-effect btn btn-info btn-sm" data-effect="effect-scale"
                                        ...
                                        data-toggle="modal" href="#edit_Product" title="تعديل"><i
                                            class="las la-pen"></i>Changer</a>


                                    <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                        data-id="{{ $key->produit }}" data-Product_name="" data-toggle="modal"
                                        href="#modaldemo9" title="حذف"><i class="las la-trash"></i>Effacer</a>
                                </td>
                            </tr>
                        @endforeach
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content modal-content-demo">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="{{ route('farine.store') }}" method="post">
                            ...
                            <div class="form-group">
                                <label for="recipient-name" class="col-form-label">Quentiter</label>
                                <input class="form-control" name="Quentiter" id="Quentiter" type="text">
                            </div>
                            <div class="form-group">
                                <label for="recipient-name" class="col-form-label">Valeur-DH</label>
        ...
        <div class="modal fade" id="edit_Product" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Chnger Produit </h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form action="{{ route('gg.update') }}" method="post">
                        @method('post')
                        @csrf
                        <div class="modal-body">
        ...
        <div class="modal" id="modaldemo9">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content modal-content-demo">
                    ...
                    <form action="{{ route('ggg.del') }}" method="post">
                        @method('delete')
                        @csrf
                        <div class="modal-body">
