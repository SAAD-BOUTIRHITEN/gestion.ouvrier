...
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 style="color: red" class="mb-0">Les Pates Alimentaires</h4>
        </div>
        <div class="col-sm-6">
                            ...
                            <tr>
                                ...
                                <td> <a class="modal-effect btn btn-info btn-sm" data-effect="effect-scale"
                                    ...
                                    <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                        data-id="{{ $key->produit }}" data-Product_name="{{ $key->produit }}"
                                        data-toggle="modal" href="#modaldemo9" title="حذف"><i
                                            class="las la-trash"></i>Effacer</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content modal-content-demo">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="{{ route('pate.store') }}" method="post">
        ...
        <div class="modal fade" id="edit_Product" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action='{{ route('up.index') }}' method="post">
                        @method('post')
                        @csrf
                        <div class="modal-body">
        ...
        <div class="modal" id="modaldemo9">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content modal-content-demo">
                    ...
                    <form action="{{ route('up.dell') }}" method="post">
                        @method('delete')
                        @csrf
                        <div class="modal-body">
